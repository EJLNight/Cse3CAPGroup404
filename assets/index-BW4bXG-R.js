...
function CreateSubAdmin() {
  ...
  const toggleStatus = (id) => {
    const updated = admins.map(
      (a) => a.id === id ? { ...a, status: a.status === "active" ? "frozen" : "active" } : a
    );
...
const exportAllRecords = (username, email, quizzes) => {
  ...
  const rows = quizzes.map(
    (q) => [username, email, q.title, q.score, q.feedback].join(",")
  );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$5.container, children: [
      ...
      foundUserData ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$5.result, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: foundUserData.quizRecords.map((q, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { style: { marginBottom: "1rem" }, children: [
...
const exportToCSV$1 = (quizzes, username) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { padding: "2rem" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$4.container, children: [
      ...
      foundUserData ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles$4.result, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: (foundUserData.quizRecords || []).map((q, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: q.title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          "Score: ",
          q.score,
...
function Checkout() {
  ...
  const handleConfirm = () => {
    ...
    const existingExpiry = ((_a = user == null ? void 0 : user.subscription) == null ? void 0 : _a.expires) ? new Date(user.subscription.expires) : null;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.container, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles.card, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { style: styles.list, children: plan.benefits.map((b, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
          "✔ ",
          b
        ] }, i)) }),
